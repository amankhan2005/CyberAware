          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
            <div className="text-center">
              ...
              <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
                ...
                <Link href="/user/report-incident" className="px-6 py-3 bg-indigo-800 text-white rounded-lg font-medium hover:bg-indigo-700 transition duration-300">
                  Report an Incident
                </Link>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden rounded-xl">
              ...
              <div className="relative">
                {indiaNews.map((item, index) => (
                  <div
                    key={item.id}
                    className={`transition-all duration-500 ${index === currentNews ? 'opacity-100 transform translate-x-0' : 'opacity-0 absolute top-0 left-0 transform translate-x-full'
                      }`}
                  >
              ...
              <div className="flex justify-center space-x-2 mt-6">
                {indiaNews.map((_, index) => (
                  <button
                    ...
                    className={`w-2.5 h-2.5 rounded-full transition-colors ${index === currentNews ? 'bg-teal-400' : 'bg-indigo-700'
                      }`}
              ...
              <div className="flex justify-center space-x-2 mt-8">
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`w-2.5 h-2.5 rounded-full transition-colors ${index === currentTestimonial ? 'bg-teal-400' : 'bg-indigo-700'
                      }`}
                  ></button>
                ))}
              </div>
